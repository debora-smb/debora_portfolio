  ...
  return (
    <>
      ...
      <div className={`innerContainer flex  justify-center h-full w-[100vw] lg:w-[90vw]`}>
        <div className={`absolute top-0 left-0 h-[90vh] bg-blackOverlay border-[10px] border-t-[0px] border-black  w-full z-10 flex items-center p-[20px] p-[5vw] md:border-[20px] md:border-t-[0px] lg:border-[20px] lg:h-full`}>
          <h1 className="text-white font-ivyPresto text-[70px] leading-[80px] md:text-[110px] md:leading-[110px] xl:text-[200px] xl:leading-[200px] 2xl:w-[1330px] 2xl:m-auto">TURNING IDEAS INTO CODE</h1>
        </div>
      </div>
    </>
  );
