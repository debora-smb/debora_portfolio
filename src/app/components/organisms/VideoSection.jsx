export default function VideoSection() {
  return (
    <>
      ...
      <video autoPlay loop muted className="h-[90vh] w-[100vw] object-cover object-center  lg:hidden border-[10px] border-t-[0px] md:border-[20px] md:border-t-[0px]  lg:border-[20px] border-black " >
      ...
      <div className={`innerContainer flex  justify-center h-full w-[100vw] lg:w-[90vw]`}>
        <div className={`absolute top-0 left-0 h-[90vh] bg-blackOverlay border-[10px] border-t-[0px] md:border-[20px] md:border-t-[0px] lg:border-[20px] border-black  lg:h-full w-full z-10 flex items-center p-[20px] p-[5vw]`}>
