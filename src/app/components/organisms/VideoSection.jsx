...
export default function VideoSection() {
  ...
  return (
    <>
      ...
      <video autoPlay loop muted className="h-[90vh] w-[100vw] object-cover object-center  border-black border-[20px] border-t-[0px] md:border-[20px] md:border-t-[0px] lg:hidden lg:border-[20px]" >
      ...
      <div className={`innerContainer flex  justify-center h-full w-[100vw] lg:w-[90vw]`}>
        <div className={`absolute top-0 left-0 h-[90vh] bg-blackOverlay border-[20px] border-t-[0px] border-black  w-full z-10 flex items-center p-[5vw] md:border-[20px] md:border-t-[0px] lg:border-[20px] lg:h-full`}>
